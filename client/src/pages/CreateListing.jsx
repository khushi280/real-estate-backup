...
export default function CreateListing() {
  ...
  const issaleRef = useRef(null);
  const isrentRef = useRef(null);
  const isparkRef = useRef(null);
  const isfurnRef = useRef(null);
  const isofferRef = useRef(null);
  ...
  return (
    <main className='p-3 max-w-5xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-x-7'>
